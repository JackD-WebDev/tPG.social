<template>
	<svg id="html-icon" viewBox="0 0 512 512">
		<path
			class="color4"
		...
		/>
		<path class="color1" d="M107.6 471l-33-370.4h362.8l-33 370.2L255.7 512" />
		<path class="color2" d="M256 480.5V131H404.3L376 447" />
		<path
			class="color3"
